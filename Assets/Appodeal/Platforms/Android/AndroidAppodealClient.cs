	...
	public class AndroidAppodealClient : IAppodealAdsClient 
	{
		...
		public void setOccupation(int occupation)
		{
			switch(occupation) 
			{
				...
				case 4:
				{
					userSettings.Call<AndroidJavaObject> ("setOccupation", new AndroidJavaClass("com.appodeal.ads.UserSettings$Occupation").GetStatic<AndroidJavaObject>("UNIVERCITY"));
					break;
				}
			}
		}
