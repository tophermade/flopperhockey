...
void AppodealDisableNetworkForAdTypes(const char * networkName, int adTypes) {
    [Appodeal disableNetworkForAdType:adTypes name:StringFromUTF8String(networkName)];
}
...
void AppodealSetUserBirthday(const char *birthday) {
    NSDate *date = [DateFormatter() dateFromString:StringFromUTF8String(birthday)];
    if (date) {
...
void AppodealSetUserEmail(const char * email) {
    [Appodeal setUserEmail:StringFromUTF8String(email)];
}

void AppodealSetUserFacebookId(const char * facebookId) {
    [Appodeal setUserFacebookId:StringFromUTF8String(facebookId)];
}

void AppodealSetUserVkId(const char * vkId) {
    [Appodeal setUserVkId:StringFromUTF8String(vkId)];
}
...
void AppodealSetUserInterests(const char * interests) {
    [Appodeal setUserInterests:StringFromUTF8String(interests)];
}
